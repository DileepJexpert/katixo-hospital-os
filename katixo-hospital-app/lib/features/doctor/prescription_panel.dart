...
class _PrescriptionPanelState extends State<PrescriptionPanel> {
  ...
  Future<void> _addItemDialog() async {
            ...
            children: [
              TextField(
                ...
                decoration: const InputDecoration(
                    labelText: 'Medicine Code *', hintText: 'PARA500'),
              ),
                ...
                children: [
                  Expanded(
                    child: TextField(
                      ...
                      decoration: const InputDecoration(
                          labelText: 'Dosage', hintText: '1 tab'),
                    ),
                  ),
                  ...
                  Expanded(
                    child: TextField(
                      controller: freqCtrl,
                      decoration: const InputDecoration(
                          labelText: 'Frequency', hintText: '1-0-1'),
                    ),
                  ),
                  const SizedBox(width: Space.md),
                  SizedBox(
    ...
    if (added == true &&
      ...
      setState(() {
        _items.add(RxItemInput(
          medicineCode: codeCtrl.text.trim().toUpperCase(),
