...
/// Doctor consult worklist: live queue with call-next / start / complete and
/// the in-line consultation + prescription panel. Body widget.
class DoctorWorklistScreen extends StatefulWidget {
  const DoctorWorklistScreen({super.key});

  @override
  State<DoctorWorklistScreen> createState() => _DoctorWorklistScreenState();
}

class _DoctorWorklistScreenState extends State<DoctorWorklistScreen> {
